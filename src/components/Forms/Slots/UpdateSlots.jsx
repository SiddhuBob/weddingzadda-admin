...
export default function AddSlots() {
  ...
  const onFinish = async (value) => {
    try {
      ...
      formData.append(
        "opening_time",
        moment(new Date(value.opening_time)).format("hh:mm a")
      );
      formData.append(
        "closing_time",
        moment(new Date(value.closing_time)).format("hh:mm a")
      );
      ...
      const resp = await post(`/slots/${value.id}`, formData, header);
  ...
  useEffect(() => {
    addForm.setFieldsValue({
      ...drawerData.value,
      opening_time: moment(drawerData.value.opening_time, "hh:mm a"),
      closing_time: moment(drawerData.value.closing_time, "hh:mm a"),
    });
  }, [drawerData]);
